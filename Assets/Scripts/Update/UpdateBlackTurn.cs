...
{
    public class UpdateBlackTurn : IUpdateble
    {
        private GameModel _gameModel;
        private GameManager _gameManager;
        private List<FreeCell> _freeCells;
        private List<Checker> _availableCheckersToMove;
        public UpdateBlackTurn(GameModel gameModel, GameManager gameManager)
        {
        ...
        public void Update()
        {
            if (Input.GetMouseButtonDown(0))
            {
                ...
                //    mousePosition.Item2 >= 0 && mousePosition.Item2 < _gameModel.Board.Height)
                //{
                //    if (_gameModel.Board.Checkers[mousePosition.Item1, mousePosition.Item2] is BlackChecker)
                //    {
